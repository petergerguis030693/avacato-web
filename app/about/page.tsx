...
export const metadata: Metadata = {
  ...
  description:
    "مكتب الأفوكاتو للمحاماة والاستشارات القانونية — باسوس، طريق القناطر الخيرية.",
      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-muted">
            مكتب الأفوكاتو للمحاماة والاستشارات القانونية — نخدم الأفراد والشركات بسرعة ودقة واحترافية.
          </p>
          <div className="mt-6 space-y-4 text-cream/90">
            ...
            <p>
              هدفنا: تحفظ حقك، وتخلّص أوراقك في أسرع وقت، وتاخد استشارة واضحة من غير لف.
            </p>
          </div>
